...
The repo for this support is located `here <https://github.com/IdentityServer/IdentityServer4/>`_ and the NuGet package is `here <https://www.nuget.org/packages/IdentityServer4.AspNetIdentity>`_.
